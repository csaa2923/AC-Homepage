...
describe("admin v2 dashboard and customer overview",()=>{
  ...
  it("guards admin v2 authentication against permanent loading states",()=>{
    ...
    assert.match(html,/firebase-auth\.js\?v=4/);
    assert.match(html,/admin-v2\.css\?v=30/);
    assert.match(html,/admin-v2\.js\?v=36/);
  ...
  it("integrates Admin V2 uploads through the existing Firebase Storage adapter",()=>{
    ...
    assert.match(html,/publish-workflow\.js\?v=7/);
    assert.match(html,/firebase-storage\.js\?v=5/);
    assert.match(html,/admin-v2\.js\?v=36"><\/script>/);
  ...
  it("integrates publication and secure portal links through existing facades only",()=>{
    ...
    const js=readProjectFile("customer-portal/admin-v2.js");
    const css=readProjectFile("customer-portal/admin-v2.css");
    assert.match(html,/redact-allowlist\.js\?v=4/);
    ...
    assert.match(js,/Kein Link vorhanden|function portalLinkBadgeLabel\(status\)/);
    ...
    assert.match(js,/Stabilen Kundenlink erzeugen/);
    assert.match(js,/Neuen Link erzeugen \(ersetzt alten\)/);
    assert.match(js,/Share-Link widerrufen/);
    assert.match(js,/db\.refreshPortalShares\(publishCandidate\.customerId\)/);
