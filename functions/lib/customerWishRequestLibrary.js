/**
 * Cloud Functions copy of the wish-request domain library.
 *
 * Firebase packs only functions/ into /workspace. Do not require
 * customer-portal/ from this tree. Keep server-used APIs aligned with
 * customer-portal/customer-wish-request-library.js.
 *
 ...
 *
 * No UI. No DOM. No Firebase. No Firestore.
 */
(function(){
  "use strict";
