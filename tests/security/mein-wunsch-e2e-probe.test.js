...
describe("Mein Wunsch E2E probe (local fixture, no deploy)",()=>{
  ...
  it("keeps current cache pins consistent for wish/journey modules",()=>{
    ...
    assert.match(adminHtml,/admin-v2-wishes\.js\?v=15/);
    assert.match(adminHtml,/admin-v2-wishes\.css\?v=11/);
    assert.match(adminHtml,/concierge-intelligence-library\.js\?v=5/);
    assert.match(adminHtml,/customer-journey-library\.js\?v=5/);
    assert.match(adminHtml,/customer-wish-request-library\.js\?v=13/);
    assert.match(portalHtml,/customer-wish-request-library\.js\?v=13/);
