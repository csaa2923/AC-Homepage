...
const T={
de:{navHome:"Home",navServices:"Leistungen",navAbout:"\u00dcber uns",navContact:"Kontakt",heroKicker:"Ihr pers\u00f6nlicher Concierge in Tirol \u2013 24/7",heroTitle:"Alpine Concierge Tirol",heroText:"Wir k\u00fcmmern uns um Restaurantreservierungen, Private Chauffeur Tirol, exklusive Reiseplanung Tirol und individuelle Erlebnisse - diskret, zuverl\u00e4ssig und mit Leidenschaft.",ctaWhatsapp:"Jetzt per WhatsApp anfragen",ctaServices:"Unsere Leistungen",enquiryNote:"Ihre Anfrage ist unverbindlich. Eine Beauftragung erfolgt erst mit der Annahme eines individuellen Angebots.",privacyNoteHtml:"Hinweise zur Verarbeitung Ihrer Angaben finden Sie in unserer <a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">Datenschutzerkl\u00e4rung</a>.",introTitle:"Mehr Zeit f\u00fcr das, was wirklich z\u00e4hlt.",introText:"Wir schaffen unvergessliche Erlebnisse und nehmen Ihnen alles ab, was Zeit kostet.",servicesLabel:"Unsere Leistungen",servicesTitle:"Ausgew\u00e4hlte Services f\u00fcr Tirol.",contactWa:"Wir sind f\u00fcr Sie da.",writeNow:"Jetzt schreiben",locationTitle:"Standort",locationText:"Innsbruck, Tirol",learnMore:"Mehr erfahren",availabilityTitle:"Erreichbarkeit",availabilityText:"24/7 f\u00fcr Sie erreichbar",learnMore2:"Mehr erfahren",requestLabel:"Anfrage",requestTitle:"Womit d\u00fcrfen wir helfen?",fieldService:"Leistung",fieldServiceDetail:"Genaue Leistung / Wunschleistung",fieldRegion:"Region",fieldPlace:"Genauer Ort / Unterkunft / Treffpunkt",fieldDate:"Datum / Zeitraum",dateSingle:"Ein Tag",dateRange:"Mehrere Tage",dateFlexible:"Flexibel",fieldSingleDate:"Datum",fieldStartDate:"Von",fieldEndDate:"Bis",fieldAdults:"Erwachsene",fieldChildren:"Kinder",childAge:"Alter Kind",moreDetails:"Weitere W\u00fcnsche angeben",fieldBudget:"Budget",fieldOccasion:"Anlass",fieldInterests:"Interessen",fieldMobility:"Mobilit\u00e4t",fieldStyle:"Stil des Erlebnisses",fieldSpecialWishes:"Besondere W\u00fcnsche",fieldMessage:"Wunsch / Nachricht",sendWa:"WhatsApp-Nachricht erstellen",chooseOption:"Bitte ausw\u00e4hlen",serviceDetailPlaceholder:"z. B. Restaurant mit Panoramablick, gef\u00fchrte Wanderung, Wellness f\u00fcr Paare ...",regionPlaceholder:"Innsbruck, Kitzb\u00fchel, \u00d6tztal",placePlaceholder:"z. B. Innsbruck Altstadt, Seefeld, Hotelname, Hungerburg ...",messagePlaceholder:"Beschreiben Sie kurz, was organisiert werden soll.",errorRequired:"Bitte f\u00fcllen Sie alle Pflichtfelder aus.",errorRange:"Das Bis-Datum darf nicht vor dem Von-Datum liegen.",errorChildAges:"Bitte geben Sie das Alter aller Kinder an.",errorTerms:"Bitte akzeptieren Sie die AGB und die Datenschutzerkl\u00e4rung.",errorEarlyStart:"Bitte best\u00e4tigen Sie den vorzeitigen Leistungsbeginn.",consentTermsHtml:"Ich habe die <a href=\"agb.html\" target=\"_blank\" rel=\"noopener noreferrer\">AGB</a> und die <a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">Datenschutzerkl\u00e4rung</a> gelesen und akzeptiere diese.",consentEarlyStart:"Ich verlange ausdr\u00fccklich, dass Alpine Concierge Tirol bereits vor Ablauf der gesetzlichen R\u00fccktrittsfrist mit der beauftragten Dienstleistung beginnt, und best\u00e4tige, \u00fcber die damit verbundenen gesetzlichen Folgen informiert worden zu sein.",legalLabel:"Rechtliches",agbTitle:"Allgemeine Gesch\u00e4ftsbedingungen",agbSubtitle:"Alpine Concierge Tirol",agbStand:"Stand: September 2026",agbPdf:"AGB als PDF herunterladen",legalBack:"Zur\u00fcck zur Startseite",agbPageTitle:"AGB | Alpine Concierge Tirol",withdrawalTitle:"Verbraucherinformation zum R\u00fccktrittsrecht",withdrawalSubtitle:"Alpine Concierge Tirol",withdrawalStand:"Stand: September 2026",withdrawalPdf:"R\u00fccktrittsinformation als PDF herunterladen",withdrawalFormPdf:"Muster-R\u00fccktrittsformular herunterladen",withdrawalPageTitle:"R\u00fccktrittsrecht | Alpine Concierge Tirol"},
en:{navHome:"Home",navServices:"Services",navAbout:"About us",navContact:"Contact",heroKicker:"Your personal concierge in Tyrol - 24/7",heroTitle:"Alpine Concierge Tirol",heroText:"We take care of restaurant bookings, private chauffeur services, exclusive travel planning and personal experiences - discreetly, reliably and with passion.",ctaWhatsapp:"Request via WhatsApp",ctaServices:"Our services",enquiryNote:"Your enquiry is non-binding. A commission is only created once you accept an individual offer.",privacyNoteHtml:"Information on how we process your details is available in our <a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">privacy policy</a>.",introTitle:"More time for what truly matters.",introText:"We create unforgettable experiences and take care of everything that costs time.",servicesLabel:"Our services",servicesTitle:"Selected services for Tyrol.",contactWa:"We are here for you.",writeNow:"Write now",locationTitle:"Location",locationText:"Innsbruck, Tyrol",learnMore:"Learn more",availabilityTitle:"Availability",availabilityText:"Available for you 24/7",learnMore2:"Learn more",requestLabel:"Request",requestTitle:"How may we help?",fieldService:"Service",fieldServiceDetail:"Exact service / wish",fieldRegion:"Region",fieldPlace:"Exact place / accommodation / meeting point",fieldDate:"Date / period",dateSingle:"One day",dateRange:"Several days",dateFlexible:"Flexible",fieldSingleDate:"Date",fieldStartDate:"From",fieldEndDate:"To",fieldAdults:"Adults",fieldChildren:"Children",childAge:"Child age",moreDetails:"Add further wishes",fieldBudget:"Budget",fieldOccasion:"Occasion",fieldInterests:"Interests",fieldMobility:"Mobility",fieldStyle:"Style of experience",fieldSpecialWishes:"Special wishes",fieldMessage:"Wish / message",sendWa:"Create WhatsApp message",chooseOption:"Please choose",serviceDetailPlaceholder:"e.g. restaurant with panoramic view, guided hike, wellness for couples ...",regionPlaceholder:"Innsbruck, Kitzb\u00fchel, \u00d6tztal",placePlaceholder:"e.g. Innsbruck old town, Seefeld, hotel name, Hungerburg ...",messagePlaceholder:"Briefly describe what should be arranged.",errorRequired:"Please complete all required fields.",errorRange:"The end date must not be before the start date.",errorChildAges:"Please enter the age of every child.",errorTerms:"Please accept the Terms and Conditions and the Privacy Policy.",errorEarlyStart:"Please confirm that you request an early start of the service.",consentTermsHtml:"I have read and accept the <a href=\"agb.html\" target=\"_blank\" rel=\"noopener noreferrer\">Terms and Conditions</a> and the <a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">Privacy Policy</a>.",consentEarlyStart:"I expressly request that Alpine Concierge Tirol begin the commissioned service before the statutory withdrawal period expires, and confirm that I have been informed of the legal consequences.",legalLabel:"Legal",agbTitle:"General Terms and Conditions",agbSubtitle:"Alpine Concierge Tirol",agbStand:"As of September 2026",agbPdf:"Download terms as PDF",legalBack:"Back to homepage",agbPageTitle:"General Terms and Conditions | Alpine Concierge Tirol",withdrawalTitle:"Consumer information on the right of withdrawal",withdrawalSubtitle:"Alpine Concierge Tirol",withdrawalStand:"As of September 2026",withdrawalPdf:"Download withdrawal information as PDF",withdrawalFormPdf:"Download model withdrawal form",withdrawalPageTitle:"Right of withdrawal | Alpine Concierge Tirol"},
it:{navHome:"Home",navServices:"Servizi",navAbout:"Chi siamo",navContact:"Contatto",heroKicker:"Il tuo concierge personale in Tirolo - 24/7",heroTitle:"Alpine Concierge Tirol",heroText:"Ci occupiamo di prenotazioni ristoranti, chauffeur privato, pianificazione di viaggio esclusiva ed esperienze personali - con discrezione, affidabilita e passione.",ctaWhatsapp:"Richiedi via WhatsApp",ctaServices:"I nostri servizi",enquiryNote:"La richiesta \u00e8 senza impegno. Un incarico nasce solo con l'accettazione di un'offerta individuale.",privacyNoteHtml:"Le informazioni sul trattamento dei dati sono nella nostra <a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">informativa sulla privacy</a>.",introTitle:"Pi\u00f9 tempo per ci\u00f2 che conta davvero.",introText:"Creiamo esperienze indimenticabili e ci occupiamo di tutto ci\u00f2 che richiede tempo.",servicesLabel:"I nostri servizi",servicesTitle:"Servizi selezionati per il Tirolo.",contactWa:"Siamo a vostra disposizione.",writeNow:"Scrivi ora",locationTitle:"Posizione",locationText:"Innsbruck, Tirolo",learnMore:"Scopri di pi\u00f9",availabilityTitle:"Disponibilit\u00e0",availabilityText:"Disponibili 24/7",learnMore2:"Scopri di pi\u00f9",requestLabel:"Richiesta",requestTitle:"Come possiamo aiutare?",fieldService:"Servizio",fieldServiceDetail:"Servizio preciso / desiderio",fieldRegion:"Regione",fieldPlace:"Luogo / alloggio / punto d'incontro",fieldDate:"Data / periodo",dateSingle:"Un giorno",dateRange:"Pi\u00f9 giorni",dateFlexible:"Flessibile",fieldSingleDate:"Data",fieldStartDate:"Da",fieldEndDate:"A",fieldAdults:"Adulti",fieldChildren:"Bambini",childAge:"Et\u00e0 bambino",moreDetails:"Aggiungi altri desideri",fieldBudget:"Budget",fieldOccasion:"Occasione",fieldInterests:"Interessi",fieldMobility:"Mobilit\u00e0",fieldStyle:"Stile dell'esperienza",fieldSpecialWishes:"Desideri speciali",fieldMessage:"Desiderio / messaggio",sendWa:"Crea messaggio WhatsApp",chooseOption:"Selezionare",serviceDetailPlaceholder:"es. ristorante con vista panoramica, escursione guidata, wellness per coppie ...",regionPlaceholder:"Innsbruck, Kitzb\u00fchel, \u00d6tztal",placePlaceholder:"es. centro storico di Innsbruck, Seefeld, nome hotel, Hungerburg ...",messagePlaceholder:"Descriva brevemente cosa desidera organizzare.",errorRequired:"Compilare tutti i campi obbligatori.",errorRange:"La data di fine non pu\u00f2 precedere quella di inizio.",errorChildAges:"Inserire l'et\u00e0 di tutti i bambini.",errorTerms:"Si prega di accettare le condizioni generali e l'informativa sulla privacy.",errorEarlyStart:"Si prega di confermare l'inizio anticipato del servizio.",consentTermsHtml:"Ho letto e accetto le <a href=\"agb.html\" target=\"_blank\" rel=\"noopener noreferrer\">condizioni generali</a> e l'<a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">informativa sulla privacy</a>.",consentEarlyStart:"Chiedo espressamente che Alpine Concierge Tirol inizi il servizio commissionato prima della scadenza del termine di recesso e confermo di essere stato informato delle conseguenze di legge."},
fr:{navHome:"Accueil",navServices:"Services",navAbout:"\u00c0 propos",navContact:"Contact",heroKicker:"Votre concierge personnel au Tyrol - 24/7",heroTitle:"Alpine Concierge Tirol",heroText:"Nous organisons reservations de restaurants, chauffeur prive, planification de voyage exclusive et experiences personnelles - avec discretion, fiabilite et passion.",ctaWhatsapp:"Demander via WhatsApp",ctaServices:"Nos services",enquiryNote:"Votre demande est sans engagement. Une commande n'intervient qu'avec l'acceptation d'une offre individuelle.",privacyNoteHtml:"Les informations sur le traitement de vos donn\u00e9es figurent dans notre <a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">politique de confidentialit\u00e9</a>.",introTitle:"Plus de temps pour ce qui compte vraiment.",introText:"Nous cr\u00e9ons des exp\u00e9riences inoubliables et prenons en charge tout ce qui demande du temps.",servicesLabel:"Nos services",servicesTitle:"Services s\u00e9lectionn\u00e9s pour le Tyrol.",contactWa:"Nous sommes \u00e0 votre disposition.",writeNow:"\u00c9crire maintenant",locationTitle:"Lieu",locationText:"Innsbruck, Tyrol",learnMore:"En savoir plus",availabilityTitle:"Disponibilit\u00e9",availabilityText:"Disponible pour vous 24/7",learnMore2:"En savoir plus",requestLabel:"Demande",requestTitle:"Comment pouvons-nous aider ?",fieldService:"Service",fieldServiceDetail:"Service pr\u00e9cis / souhait",fieldRegion:"R\u00e9gion",fieldPlace:"Lieu / h\u00e9bergement / point de rencontre",fieldDate:"Date / p\u00e9riode",dateSingle:"Un jour",dateRange:"Plusieurs jours",dateFlexible:"Flexible",fieldSingleDate:"Date",fieldStartDate:"Du",fieldEndDate:"Au",fieldAdults:"Adultes",fieldChildren:"Enfants",childAge:"\u00c2ge enfant",moreDetails:"Ajouter d'autres souhaits",fieldBudget:"Budget",fieldOccasion:"Occasion",fieldInterests:"Int\u00e9r\u00eats",fieldMobility:"Mobilit\u00e9",fieldStyle:"Style de l'exp\u00e9rience",fieldSpecialWishes:"Souhaits particuliers",fieldMessage:"Souhait / message",sendWa:"Cr\u00e9er un message WhatsApp",chooseOption:"Veuillez choisir",serviceDetailPlaceholder:"p. ex. restaurant avec vue panoramique, randonn\u00e9e guid\u00e9e, bien-\u00eatre pour couples ...",regionPlaceholder:"Innsbruck, Kitzb\u00fchel, \u00d6tztal",placePlaceholder:"p. ex. vieille ville d'Innsbruck, Seefeld, nom de l'h\u00f4tel, Hungerburg ...",messagePlaceholder:"D\u00e9crivez bri\u00e8vement ce qui doit \u00eatre organis\u00e9.",errorRequired:"Veuillez remplir tous les champs obligatoires.",errorRange:"La date de fin ne doit pas pr\u00e9c\u00e9der la date de d\u00e9but.",errorChildAges:"Veuillez indiquer l'\u00e2ge de chaque enfant.",errorTerms:"Veuillez accepter les conditions g\u00e9n\u00e9rales et la politique de confidentialit\u00e9.",errorEarlyStart:"Veuillez confirmer le d\u00e9but anticip\u00e9 de la prestation.",consentTermsHtml:"J'ai lu et j'accepte les <a href=\"agb.html\" target=\"_blank\" rel=\"noopener noreferrer\">conditions g\u00e9n\u00e9rales</a> et la <a href=\"datenschutz.html\" target=\"_blank\" rel=\"noopener noreferrer\">politique de confidentialit\u00e9</a>.",consentEarlyStart:"Je demande express\u00e9ment qu'Alpine Concierge Tirol commence la prestation command\u00e9e avant l'expiration du d\u00e9lai de r\u00e9tractation et confirme avoir \u00e9t\u00e9 inform\u00e9(e) des cons\u00e9quences l\u00e9gales."}
};
...
function setConsentInvalid(id,invalid){
...
function isBindingRequest(){
  return !!document.querySelector("[data-binding-request='true']");
}

function updateBindingConsent(){
  const wrap=document.getElementById("earlyStartConsent");
  const input=document.getElementById("earlyStartAccept");
  if(!wrap||!input)return;
  const binding=isBindingRequest();
  wrap.hidden=!binding;
  input.required=binding;
  input.setAttribute("aria-required",binding?"true":"false");
  if(!binding){
    input.checked=false;
    setConsentInvalid("earlyStartAccept",false);
  }
}

function renderConsentCopy(lang){
  const dict=T[lang]||T.de;
  const note=document.getElementById("privacyNote");
  if(note&&dict.privacyNoteHtml)note.innerHTML=dict.privacyNoteHtml;
  const text=document.getElementById("termsAcceptText");
  if(text&&dict.consentTermsHtml)text.innerHTML=dict.consentTermsHtml;
}

function renderLegalLanguage(lang){
  const pairs=[["agbLangDe","agbLangEn"],["withdrawalLangDe","withdrawalLangEn"]];
  const showEn=lang==="en";
  let active=null;
  pairs.forEach(([deId,enId])=>{
  ...
  if(!active)return;
  const dict=showEn?(T.en||T.de):T.de;
  document.querySelectorAll("[data-i18n='legalLabel'],[data-i18n='agbTitle'],[data-i18n='agbSubtitle'],[data-i18n='agbStand'],[data-i18n='agbPdf'],[data-i18n='legalBack'],[data-i18n='withdrawalTitle'],[data-i18n='withdrawalSubtitle'],[data-i18n='withdrawalStand'],[data-i18n='withdrawalPdf'],[data-i18n='withdrawalFormPdf']").forEach(el=>{
    const key=el.dataset.i18n;
    if(dict[key])el.textContent=dict[key];
  });
  if(active==="withdrawalLangDe"&&dict.withdrawalPageTitle)document.title=dict.withdrawalPageTitle;
  else if(active==="agbLangDe"&&dict.agbPageTitle)document.title=dict.agbPageTitle;
}
...
function setLang(lang){
  ...
  renderConsentCopy(lang);
  renderLegalLanguage(lang);
  updateBindingConsent();
}
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  ["termsAccept","earlyStartAccept"].forEach(id=>{
    const input=document.getElementById(id);
    if(!input)return;
    input.addEventListener("change",()=>{
      if(input.checked)setConsentInvalid(id,false);
    });
  });
  const consentRoot=document.getElementById("requestConsent");
  if(consentRoot)consentRoot.addEventListener("click",event=>{
